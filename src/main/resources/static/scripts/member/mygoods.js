$('#shopTable').bootstrapTable({
    ...
    columns: [{
        ...
        formatter: function (value, row, index) {
            ...
            return '  <div class="sm_img"><a href="'+url+'" style="margin-top: 0px" target="_blank"><img src="http://secondhand-oss.oss-cn-beijing.aliyuncs.com/'+row.imageArr[0]+'?x-oss-process=style/48_size" width="48" height="48" style="margin-top: 0px"></a></div>\n' +
